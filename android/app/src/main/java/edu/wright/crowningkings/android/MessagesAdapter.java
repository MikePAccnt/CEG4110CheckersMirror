    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message.messageType != MessageType.RECEIVED) {
            ...
            switch (message.messageStatus) {
                case SUCCESSFUL:
                    tvMessageBackground = messageTypeContainer.getResources().getDrawable(R.drawable.round_rectangle_accent);  // TODO getDrawable(id, Theme) for lollipop
                    break;
                case UNSUCCESSFUL:
                    tvMessageBackground = messageTypeContainer.getResources().getDrawable(R.drawable.round_rectangle_primary);  // TODO getDrawable(id, Theme) for lollipop
                    break;
                case IN_PROGRESS:
